...
оценка защищенности, проведение аудитов ИБ и тестов на проникновение, подготовка и сертификация по PCI и PA-DSS, СТО БР ИББС, Положению ЦБ РФ № 382-П, аудит защищенности банковских систем (ДБО, АБС), SCADA, ERP-систем, бизнес-приложений, веб-приложений и платформ виртуализации.

разработка систем по анализу защищенности ERP-систем (сканер уязвимостей): мониторинг настроек, анализ исходного кода, анализ бизнес-привилегий.
...
Анализ существующих практик, публикаций, открытых источников по тематике обеспечения безопасности корпоративных приложений.
...
Методы анализа сетевых технологий, протоколов
проведение атак и знание методов защиты.

Понимание возможностей и принципов функционирования средств обеспечения ИБ, принципов аутентификации, авторизации и разделения полномочий.

Знание  основных методик, классификаций и международных практик (OWASP, CVSS).
