...
* Описание выявленных недостатков в корпоративных приложениях, обоснование угроз, составление рекомендаций и предложений по их устранению/предупреждению (ПК-7);
* Проведение Аналитических и статистических исследований программного обеспечения (ПК-8);
* сравнительный анализ конкурентных решений, частичное тестирование, написание эксплоитов, поиск уязвимостей (ПК-9);
* способностью к проведению анализа сетевых технологий, протоколов различными методами (ПК-10);

####проектно-конструкторская деятельность:####

* способностью к анализу состояния научно-технической проблемы, технического задания и постановке цели и задач проектирования систем защиты информации на основе подбора и изучения литературных и патентных источников (ПК-11);
* способностью к конструированию и разработке систем и комплексов обеспечения защиты информации с использованием средств компьютерного проектирования; проведением проектных расчетов и технико-экономическим обоснованием (ПК-12);
* способностью к проведению технических расчетов по проектам, технико-экономическому и функционально-стоимостному анализу эффективности проектируемых комплексов и систем, включая оценку инновационных рисков коммерциализации проектов (ПК-13);
* способностью к составлению технической документации, включая инструкции по эксплуатации, программы испытаний, технические условия и другие (ПК-14);
* Разработка технической и аналитической документации, составление ТЗ на основе полученных бизнес-требований (ПК-15);

####производственно-технологическая деятельность:####

* способностью к проектированию, разработке и внедрению технологических процессов и режимов производства, контролю качества оптических и оптико-электронных приборов и систем и их элементов (ПК-16);
* способностью к разработке технических заданий на проектирование систем компьютерной защиты информации (ПК-17);
* способностью кпроведению аудита защищенности банковских систем (ДБО, АБС), SCADA, ERP-систем, бизнес-приложений, веб-приложений и платформ виртуализации (ПК-18);
* Анализ программного кода на предмет наличия уязвимостей, недекларированных возможностей, программных закладок (ПК-19);
* способностью к проведению атак на компьютерные системы, системы защиты информации, системы предотвращения и обнаружения вторжений, системы антивирусной защиты и другие (ПК-20);

####организационно-управленческая деятельность:####

* способностью к организации работы научно-производственного коллектива, принятию исполнительских решений (ПК-21);
* способностью к разработке планов научно-исследовательских работ и управлению ходом их выполнения, включая обеспечение соответствующих служб необходимой технической документацией, материалами, оборудованием (ПК-22);
* способностью к организации работ по совершенствованию, модернизации, унификации разрабатываемых систем защиты информации, а также их элементов (ПК-23);
* способностью к оценке защищенности систем защиты(ПК-24);
* способностью к конфигурации сложных систем: анализ настроек и механизмов безопасности(ПК-25);
* способностью к управлению программами освоения новыми системами и технологиями защиты информации (ПК-26).
